...
# Query
question = "Can you give me an example activity you can do in the place in the picture?"
...
if not use_image:
    ...
    image_embeddings = torch.tensor(struct.unpack('<' + 'f' * num_floats, byte_array), dtype=torch.float16).unsqueeze(0).unsqueeze(0).cuda()
else:
