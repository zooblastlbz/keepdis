...
if __name__ == "__main__":
    ...
    parser.add_argument("--base-dir-responses", type=str, default="answers",
                        help="Base directory for answer files.")
    parser.add_argument("--transformed-queries-dir", type=str, default="transformed_queries",
    ...
    for query_folder, code in query_folders:
        ...
        args.answers_file = os.path.join(answers_dir, f"{args.attack_category}_{query_folder}_answers.jsonl")
        args.image_folder = f"imgs/{args.attack_category}/"

        print(f"Processing folder: {query_folder}")
        eval_model(args)